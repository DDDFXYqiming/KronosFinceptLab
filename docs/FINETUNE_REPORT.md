...
**v2 (2010-2026 扩展数据) 结论**: 将时间范围从 2022 扩展到 2010 年（数据量 3.6x）并未提升方向准确率（87.4% vs 87.6%），说明：
- 更旧的数据对当前市场预测的贡献有限
- 市场动态会随时间变化，近期数据比远期数据更有价值
- 最佳策略是使用近期数据（2022+）训练，数据量充足不需要堆时间

**最佳模型: v1 (2022-2026 数据, 5 epoch)**
